...
Revision ID: 16c3d0ba063e
Revises: f0d18d034a1d
Create Date: 2023-12-07 10:52:35.094277
...
revision: str = '16c3d0ba063e'
down_revision: Union[str, None] = 'f0d18d034a1d'
...
def downgrade() -> None:
    ...
    sa.Column('producer', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('price', sa.VARCHAR(), autoincrement=False, nullable=True),
    sa.Column('characteristic', sa.VARCHAR(), autoincrement=False, nullable=True),
